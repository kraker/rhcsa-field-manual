...
doc:
  ...
  owner: akraker
  notes:
    - Substantial command reference appendix.
---
...
exports -avr                  # Export all shares with verbose output
exports -v                    # Show current exports
exports -u /export/share      # Unexport specific share
exports -ra                   # Re-export all shares
...
This comprehensive command reference covers all major [RHCSA](02-glossary.qmd) topics with practical command examples organized by functional area for efficient study and quick reference during exam preparation.
